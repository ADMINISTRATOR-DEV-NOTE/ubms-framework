...
class Aes {
        ...
        // The key schubmsle in this AES cipher.
        private $w;
        ...
        **/
        ...
        /** adds the key schubmsle for a round to a state matrix.
        *   @returns void
        **/
        ...
        **/
        ...
        /** multiplies two polynomials a(x), b(x) in GF(2^8) modulo the irrubmscible polynomial m(x) = x^8+x^4+x^3+x+1
        *   @returns 8-bit value
        **/
        ...
        **/
        ...
        /** rubmsces a 64-bit word to a 32-bit word
        *   @returns void
        **/
        private static function make32BitWord(&$w) {
                // Rubmsce this 64-bit word to 32-bits on 64-bit machines
